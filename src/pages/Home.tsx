...
import { Upload, FileText, ArrowRight, Loader2, CheckCircle2, ShieldCheck, Zap, AlertCircle } from "lucide-react";
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (!contentToAnalyze || contentToAnalyze.trim().length < 10) {
        throw new Error("Document text is too short or empty. Please provide more content.");
      }

      // 2. Analyze the content directly from the frontend
      ...
      sessionStorage.setItem("originalDocumentText", contentToAnalyze);
      navigate("/analysis");
    } catch (error) {
          ...
          >
            <div className="rounded-3xl bg-white p-8 shadow-xl shadow-indigo-100/50 border border-indigo-50">
              ...
              <div className="space-y-6">
                ...
                {error && (
                  <div className="rounded-xl bg-rose-50 p-4 text-sm text-rose-600 border border-rose-100 flex items-center gap-3">
